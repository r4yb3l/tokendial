...
public sealed class SettingsWindow : Window
{
    ...
    private readonly DisplayChooser displayChooser = new();
    ...
    private void OnScreensChanged(object? sender, EventArgs e) => RefreshDisplays();

    private void RefreshDisplays() => displayChooser.Update(ScreenChoice.All(Screens), settings.Display, value =>
    {
